...
function csNewScenario(name){
  return {
    ...
    /* Bangkok Metropolis TMYx 2011-2025 (WMO 484550), the 08:00-17:00
       Mon-Fri hours: mean enthalpy 77.04 kJ/kg. 31 C / 63 % reproduces it
       to 0.3 %. The old default of 31 C / 70 % is 82.21 kJ/kg, which
       against a 25 C / 50 % room overstates the load - and therefore the
       saving - by 19 %. See _src/bkk_enthalpy.py. */
